...
import com.gads2020.practice.databinding.ActivitySubmitBinding
import com.gads2020.practice.ui.fragments.AlertFragment
...
class SubmitActivity : AppCompatActivity(), AlertFragment.OnRequestConfirmationListener {
    ...
    private fun processForm() {
        ...
        RetrofitClient.getFormInstance().postSubmission(firstName, lastName, emailAddress, repoLink)
